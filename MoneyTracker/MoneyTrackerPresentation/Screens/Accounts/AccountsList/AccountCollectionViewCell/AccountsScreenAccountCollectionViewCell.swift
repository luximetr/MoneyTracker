...
final class AccountCollectionViewCell: AppearanceCollectionViewCell {
    ...
    let deleteButton = TextFilledButton(appearance: CompositeAppearance(fonts: DefaultAppearanceFonts(), colors: DarkAppearanceColors(), images: DefaultAppearanceImages()))
