...
struct OperationSelectedRow {
    ...
    let balanceTransferAmount: Int64?
...
class OperationSqliteView {
    ...
    func createIfNotExists() throws {
        let statement =
            ...
            operation (
                ...
                expense_category_icon_name,
                expense_category_color_type,
            ...
            SELECT
                ...
                balance_transfer.from_amount AS balance_transfer_amount,
    ...
    private func extractHistorySelectedRow(_ preparedStatement: OpaquePointer?) throws -> OperationSelectedRow {
        ...
        let balanceTransferAmount = sqlite3ColumnInt64(databaseConnection, preparedStatement, 29)
