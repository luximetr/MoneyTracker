...
class Application: AUIEmptyApplication, PresentationDelegate {
    ...
    private lazy var presentation: Presentation = {
        ...
        let presentation = Presentation(window: presentationWindow, language: presentationLanguage, appearanceSetting: presentationAppearanceSetting)
...
//        let operations = try storage.getOperations()
        let filesExpenses = storageExpenses.compactMap { storageExpense -> FilesExportingExpense? in
